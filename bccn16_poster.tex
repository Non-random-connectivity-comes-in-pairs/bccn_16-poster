...
\usepackage{tgheros}
%\usepackage{eulermath} %additional math
...
\veryHuge \textbf{Non-random connectivity comes in pairs} \color{Black}\\ % Title
\Huge\textit{}\\[2cm] % Subtitle
\huge \textbf{Felix Z. Hoffmann, Jochen Triesch}\\[0.5cm] % Author(s)
\huge Frankfurt Institute for Advanced Studies (FIAS), Johann Wolfgang Goethe University, Frankfurt am Main, Germany\\[0.4cm] % University/organization
